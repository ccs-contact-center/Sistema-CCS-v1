...
Public Class FODA_Sup
    ...
    Sub GuardaRetro()
        ...
        Dim strQuery As String = "UPDATE QA.dbo.SYS_monitoreos SET fecha_retro_sup = GETDATE(), comentario_super = '" & TextBox2.Text & "', retro_super = 1 WHERE id = " & Session("idSeleccion")
        ...
        Alerta.EnviarMail(Alerta.GetCorreoAnalista(Session("idSeleccion")), Alerta.GetListaNotificacion(1, x.GetUserIDACD(Dato6.Text)), "***Retroalimentación: FODA***", MensajeFODA)
    ...
    Sub GetGenerales()
        ...
        TextBox1.Text = ds.Tables(0).Rows(0).Item(18).ToString
