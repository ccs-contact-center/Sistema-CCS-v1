<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Masterpages/Content.Master" CodeBehind="Coaching.aspx.vb" Inherits="CCS.Coaching" %>
                ...
                <ContentTemplate>
                    <asp:Panel ID="Panel1" runat="server" CssClass="Panel">
                        ...
                        <div runat="server" id="Alta1" style="margin-left: 30px;">
                            ...
                            <asp:Panel ID="Panel21" runat="server" Width="700px" CssClass="margencitobottom" Visible="false">
                                <table style="width: 100%">
                                    <tr>
                                    ...
                                    <tr>
                                        <td>
                                            <asp:TextBox ID="TextBox12" runat="server" BorderStyle="None" Height="40px" TextMode="MultiLine" Width="100%" CssClass="textos"></asp:TextBox>
                                             <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="TextBox12" Display="Dynamic" ErrorMessage="*" ForeColor="Red" ValidationGroup="Valida1"></asp:RequiredFieldValidator>
                                        </td>
                                    </tr>
                                  ...
                                  <asp:Panel ID="Panel20" runat="server" Width="700px" CssClass="margencitobottom" Visible="false">
                                <table style="width: 100%">
                                    <tr>
                                    ...
                                    <tr>
                                        <td>
                                            <asp:TextBox ID="TextBox13" runat="server" BorderStyle="None" Height="40px" TextMode="MultiLine" Width="100%" CssClass="textos"></asp:TextBox>
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="TextBox13" Display="Dynamic" ErrorMessage="*" ForeColor="Red" ValidationGroup="Valida1"></asp:RequiredFieldValidator>
                            ...
                            <asp:Panel ID="Panel4" runat="server" Width="700px" CssClass="margencitofull">
                                <table style="width: 100%">
                                    ...
                                    <tr>
                                        ...
                                        <td runat="server" id="FirmaAgente">
