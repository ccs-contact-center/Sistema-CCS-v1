<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Masterpages/Content.Master" CodeBehind="FODA_Sup.aspx.vb" Inherits="CCS.FODA_Sup" %>
                        ...
                        <div runat="server" id="Comentario" visible="True" style="padding-left: 25px;">
                            <asp:Panel ID="Panel5" runat="server" Width="700px" CssClass="margencitobottom">
                                <table style="width: 100%">
                                    ...
                                    <tr>
                                        <td colspan="6" class="auto-style2">
                                            <asp:TextBox ID="TextBox1" runat="server" BorderStyle="None" Height="40px" TextMode="MultiLine" Width="100%" CssClass="textos" ReadOnly="True"></asp:TextBox>
                                    ...
                                    <tr>
                                        <td colspan="6" class="auto-style2">
                                            <asp:TextBox ID="TextBox2" runat="server" BorderStyle="None" Height="40px" TextMode="MultiLine" Width="100%" CssClass="textos"></asp:TextBox>
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="TextBox2" Display="Dynamic" ErrorMessage="*" ForeColor="Red" ValidationGroup="Valida1"></asp:RequiredFieldValidator>
                                        </td>
                                    </tr>
                            ...
                            <asp:Panel ID="Panel14" runat="server" Width="700px" CssClass="margencito" Visible="false">
                                <table style="width: 100%">
                                    <tr>
                                        <td colspan="6" class="TablaRubros">¿ Qué ocasionó que no realizarás el proceso correcto de HOLD? </td>
                                    </tr>

                                    <tr>
                                        <td>
                                            <asp:TextBox ID="TextBox12" runat="server" Height="40px" TextMode="MultiLine" Width="690px"></asp:TextBox>
                                        </td>
                                    </tr>
                                  ...
                                  <asp:Panel ID="Panel15" runat="server" Width="700px" CssClass="margencito" Visible="false">
                                <table style="width: 100%">
                                    <tr>
                                        <td colspan="6" class="TablaRubros">¿Solicitaste apoyo para atender esta llamada y a quién? </td>
                                    </tr>

                                    <tr>
                                        <td>
                                            <asp:TextBox ID="TextBox13" runat="server" Height="40px" TextMode="MultiLine" Width="690px"></asp:TextBox>
                                        </td>
                                    </tr>
