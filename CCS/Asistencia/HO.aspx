<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Masterpages/Content.Master" CodeBehind="HO.aspx.vb" Inherits="CCS.HO" EnableEventValidation="false" %>
                        ...
                        <div style="margin-left: 4px; margin-right: 4px;" class="auto-style6">
                            ...
                            <table class="auto-style7">
                                ...
                                <tr>
                                    ...
                                    <td class="auto-style2">Campaña:&nbsp;&nbsp;<asp:DropDownList ID="DropDownList1" runat="server" AutoPostBack="True" Width="150px">
                                        </asp:DropDownList>
                                    ...
                                    <td class="auto-style2">Curso: &nbsp;&nbsp;<asp:DropDownList ID="DropDownList2" runat="server" AutoPostBack="True" Width="150px">
                                        </asp:DropDownList>
