<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Masterpages/Content.Master" CodeBehind="Secundarias.aspx.vb" Inherits="CCS.Secundarias" EnableEventValidation="false" %>
                        ...
                        <div style="margin-left: 4px; margin-right: 4px;" class="auto-style6">
                            ...
                            <table class="auto-style7">
                                ...
                                <tr>
                                    ...
                                    <td class="auto-style2">Campaña Principal:&nbsp;&nbsp;<asp:DropDownList ID="DropDownList1" runat="server" AutoPostBack="True" Width="150px">
                                        </asp:DropDownList>
                                    ...
                                    <td class="auto-style2">Capacitacion Secundaria: &nbsp;&nbsp;<asp:DropDownList ID="DropDownList2" runat="server" AutoPostBack="True" Width="150px">
                                        </asp:DropDownList>
                                         <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="DropDownList2" ErrorMessage="*" ForeColor="Red" InitialValue="0" ValidationGroup="Valida2"></asp:RequiredFieldValidator>
                                    </td>
                                    <td>
                                        &nbsp;</td>
                                </tr>
